...
class PIIClassificationAgent:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._parallel_mode = False  # Track if we're in parallel mode
    ...
    def run(self, topics: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        # Mark that we're in parallel mode
    ...
    def _process_topic(self, topic: str) -> Dict[str, Any]:
        ...
        try:
            ...
            tagging_results = {}
            if self.config['tagging']['enabled']:
    ...
    def _is_parallel_mode(self) -> bool:
        ...
        return getattr(self, '_parallel_mode', False)
